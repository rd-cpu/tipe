...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.8\linewidth,height=0.45\textheight,keepaspectratio]{\detokenize{Images/geogebra-export.png}}
	\end{figure}
...
\subsection{Formalisation des propriétés géométriques}

\begin{frame}
	\frametitle{Formalisation des propriétés géométriques}
	
	\begin{block}{Forme de Weierstrass}
...
\subsection{Construiction d'un groupe cyclique}
...
\begin{frame}
	...
	\begin{block}{Application aux courbes elliptiques}
		Pour chaqeu couple d'entiers $(x,y)$ vérifiant l'équation de la courbe elliptique, on applique un modulo à $x$ et à $y$.
