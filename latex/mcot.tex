...
décryption se doivent d'être rapides et peu coûteuses à mettre en place.\\
...
des anniversaires et de la reconnaissance de cycles dans l'apparition des valeurs. 
...
\bibitem{nsa2005}
National Security Agency (NSA). (2005). \textit{The Case for Elliptic Curve Cryptography}. Suite B Cryptography.
