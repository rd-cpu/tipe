...
rho de Pollard \cite{rdp} , ont une complexité exponentielle en le nombre de bits de l'ordre du groupe.\\
...
Nous allons donc étudier la sécurité de ce cryptosystème en jouant le rôle d'un attanquant 
